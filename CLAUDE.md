...
- **PLI/FIR rate-limit**: `on_keyframe_request_cb` в `webrtc_streamer.c` пропускает запросы чаще 1.5 с. IDR retry timer (5×2с) работает независимо — вызывает `camera_request_idr()` напрямую.
